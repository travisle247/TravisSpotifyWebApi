...
using TravisSpotifyWebService.SpotifyModel;
...
namespace TravisSpotifyWebService.Models
{
    public class Artist : BaseModel
    {
        ...
        {
            var json = await HttpHelper.Get("https://api.spotify.com/v1/artists/" + artistId);
        ...
        /// <returns></returns>
        public static async Task<List<Track>> GetTopTracks(string artistId, string countryCode = "US")
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<Track>> GetTopTracks(string countryCode = "US")
        {
            return await GetTopTracks(this.Id, countryCode);
        }
